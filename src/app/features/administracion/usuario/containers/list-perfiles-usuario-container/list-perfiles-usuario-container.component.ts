...
@Component({
  ...
  styleUrls: ['./list-perfiles-usuario-container.component.scss'],
})
export class ListPerfilesUsuarioContainerComponent
  implements OnInit, OnDestroy
{
  ...
  editarSuperior(item: ListPerfilesUserType): void {
    this.userFacade.displayModalPerfilesUser(true);
    this.userFacade.getAllPerfiles();
    this.userFacade.perfilSelected(item);
  }

  eliminar(item: ListPerfilesUserType): void {
    this.displayModalEliminarPerfilUsuario = true;
    this.usuarioproxy_id = item.proxy_id;
  }
}
