...
Crear OT MOVIL
   ...
   # Extras
    ...
    sleep                1
    _OTCheckInfoBase     Movil    UNIFICADO-2019-MOVIL    Cub Movil    Autorizar OT por Proveedor    Abierta    JESSICA MOVISTAR CASTILLO 1    JESSICA MOVISTAR CASTILLO 1    Descripcion de algo movil
    _OTCheckInfoBucle    0189     
