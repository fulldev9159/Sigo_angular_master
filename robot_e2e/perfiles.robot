...
# #    ${"selector permisos del modulo CUBICACION"}     set variable                         css:#modulos-pefil-CUBICACION>p-listbox>div>div.p-listbox-list-wrapper>ul>li
# #    ${permisos del modulo CUBICACION}=               Get WebElements                      ${"selector permisos del modulo CUBICACION"}
# #    Click Element                                ${permisos del modulo CUBICACION}[0]
#     ${Option Listar CUBICACION}=                     set variable                         css:#modulos-pefil-CUBICACION>p-listbox>div>div.p-listbox-list-wrapper>ul>li:nth-child(1)
#     Click Visible Element                        ${Option Listar CUBICACION}
# #    ${"selector permisos del modulo PERFILE"}    set variable                         css:#modulos-pefil-PERFIL>p-listbox>div>div.p-listbox-list-wrapper>ul>li
# #    ${permisos del modulo PERFIL}=              Get WebElements                      ${"selector permisos del modulo PERFIL"}
# #    Click Element                                ${permisos del modulo PERFIL}[0]
#     ${Option Listar PERFIL}=                    set variable                         css:#modulos-pefil-PERFIL>p-listbox>div>div.p-listbox-list-wrapper>ul>li:nth-child(1)
#     Click Visible Element                        ${Option Listar PERFIL}
...
# Al presionar boton eliminar no desaparece de la lista el borrado