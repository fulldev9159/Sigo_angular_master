...
Crear cubicación
   ...
   # Then: La cubicación debe aparecer en el listado con los datos correctos
    ...
    _Select visible item    css:#proveedores > app-select > select
    ...
    _Select visible item    css:#actividad > app-select > select          
    _Select visible item    css:#tiposervicio > app-select > select